...
const CONTACTO_EMAIL = "info@blizzcool.es";
...
$host = isset($_SERVER["HTTP_HOST"]) ? preg_replace('/[^a-zA-Z0-9.\-]/', "", $_SERVER["HTTP_HOST"]) : "blizzcool.es";
$remitente = "catalogo@$host";

$cabeceras = [];
$cabeceras[] = "From: Catálogo Blizzcool <$remitente>";
